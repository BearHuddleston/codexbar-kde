...
### CodexBar KDE 0.2.1 — MIT

- Project source: <https://github.com/BearHuddleston/codexbar-kde/tree/v0.2.1>
...
### CodexBar provider icons — MIT

The provider brand icons in `src/codexbar_kde/assets/icons/` are vendored from
the CodexBar project's `Sources/CodexBar/Resources/ProviderIcon-*.svg` set and
recolored (dark fills replaced with white) for dark-surface rendering.

- Upstream source: <https://github.com/steipete/CodexBar>
- License: MIT (see upstream repository)

The glyphs depict third-party provider brands; they identify the services and
imply no endorsement by the trademark holders.
...
- Release mirror: <https://github.com/BearHuddleston/codexbar-kde/releases/download/v0.2.1/PyQt6-6.7.1.tar.gz>
...
- Release mirror: <https://github.com/BearHuddleston/codexbar-kde/releases/download/v0.2.1/qt-everywhere-src-6.7.1.tar.xz>
...
- Release mirror: <https://github.com/BearHuddleston/codexbar-kde/releases/download/v0.2.1/PyQt6_sip-13.8.0.tar.gz>
...
- Build project commit: <https://github.com/niess/python-appimage/commit/984f77af087e2e514d3b3ab64fb01d57ba2eb76e>
- Build project source mirror: <https://github.com/BearHuddleston/codexbar-kde/releases/download/v0.2.1/python-appimage-984f77af087e2e514d3b3ab64fb01d57ba2eb76e.tar.gz>
- Build project source SHA-256: `8d9c8297ea699cbe6ec92381d7748e7ce54eff498ea0489f79d6049074433948`
- CPython corresponding source: <https://www.python.org/ftp/python/3.11.14/Python-3.11.14.tar.xz>
- CPython release mirror: <https://github.com/BearHuddleston/codexbar-kde/releases/download/v0.2.1/Python-3.11.14.tar.xz>
