...
### CodexBar KDE 0.2.0 — MIT

- Project source: <https://github.com/BearHuddleston/codexbar-kde/tree/v0.2.0>
...
- Release mirror: <https://github.com/BearHuddleston/codexbar-kde/releases/download/v0.2.0/PyQt6-6.7.1.tar.gz>
...
- Release mirror: <https://github.com/BearHuddleston/codexbar-kde/releases/download/v0.2.0/qt-everywhere-src-6.7.1.tar.xz>
...
- Release mirror: <https://github.com/BearHuddleston/codexbar-kde/releases/download/v0.2.0/PyQt6_sip-13.8.0.tar.gz>
...
- Build project source mirror: <https://github.com/BearHuddleston/codexbar-kde/releases/download/v0.2.0/python-appimage-984f77af087e2e514d3b3ab64fb01d57ba2eb76e.tar.gz>
...
- CPython release mirror: <https://github.com/BearHuddleston/codexbar-kde/releases/download/v0.2.0/Python-3.11.14.tar.xz>
